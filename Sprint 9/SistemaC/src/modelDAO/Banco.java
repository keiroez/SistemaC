...
public class Banco{
	...
	public void inserirProntuario(String prontuario, String cpf, Date data, Time hora){
		...
		try {
			...
			String update = "UPDATE AGENDA SET PRONTUARIOAGENDA = '"+prontuario+"' WHERE CPFPACIENTE = '"+cpf+"' AND DATAAGENDAMENTO = '"+data+"' AND HORA = '"+hora+"' ;";
	...
	public String buscarProntuario(String cpf, Date data, Time hora){
		...
		try {
			...
			String query = "SELECT PRONTUARIOAGENDA FROM AGENDA  WHERE CPFPACIENTE = '"+cpf+"' AND DATAAGENDAMENTO = '"+data+"' AND HORA = '"+hora+"' ;";
			this.resultSet = this.statement.executeQuery(query);
